...
class Ink {
  constructor(options) {
    ...
    this.rootNode.onRender = options.debug ? this.onRender : throttle__default["default"](this.onRender, 32, {
      leading: true,
      trailing: true
    });
    this.rootNode.onImmediateRender = this.onRender;
    this.log = logUpdate.create(options.stdout);
    this.throttledLog = options.debug ? this.log : throttle__default["default"](this.log, 0, {
      leading: true,
      trailing: true
    });
