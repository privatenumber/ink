import React, { createContext, forwardRef, PureComponent, useState, useMemo, useLayoutEffect, useContext, useEffect } from 'react';
...
var reconciler = createReconciler({
  ...
  hideInstance: (node) => {
    var _a;
    (_a = node.yogaNode) == null ? void 0 : _a.setDisplay(Yoga.DISPLAY_NONE);
  },
  unhideInstance: (node) => {
    var _a;
    (_a = node.yogaNode) == null ? void 0 : _a.setDisplay(Yoga.DISPLAY_FLEX);
  },
...
var colorize = (str, color, type) => {
  ...
  if (isRgbLike) {
    ...
    return chalk[method](firstValue, secondValue, thirdValue)(str);
  }
  return str;
};
...
const Text = ({
  ...
  const transform = (children2) => {
    ...
    if (bold) {
      children2 = chalk.bold(children2);
    }
    if (italic) {
      children2 = chalk.italic(children2);
    }
    if (underline) {
      children2 = chalk.underline(children2);
    }
    if (strikethrough) {
      children2 = chalk.strikethrough(children2);
    }
    if (inverse) {
      children2 = chalk.inverse(children2);
    }
    return children2;
  };
...
const ErrorOverview = ({ error }) => {
  ...
  let excerpt;
  let lineWidth = 0;
  if ((origin == null ? void 0 : origin.file) && (origin == null ? void 0 : origin.line) && fs.existsSync(origin.file)) {
  ...
  return /* @__PURE__ */ React.createElement(Box, {
    ...
    backgroundColor: "red",
    color: "white"
  }, " ", "ERROR", " "), /* @__PURE__ */ React.createElement(Text, null, " ", error.message)), origin && /* @__PURE__ */ React.createElement(Box, {
    marginTop: 1
  }, /* @__PURE__ */ React.createElement(Text, {
    dimColor: true
  }, origin.file, ":", origin.line, ":", origin.column)), origin && excerpt && /* @__PURE__ */ React.createElement(Box, {
    marginTop: 1,
    flexDirection: "column"
...
class App extends PureComponent {
  ...
  render() {
    ...
    }, /* @__PURE__ */ React.createElement(StdinContext.Provider, {
      value: {
    ...
    }, /* @__PURE__ */ React.createElement(StdoutContext.Provider, {
      value: {
        stdout: this.props.stdout,
        write: this.props.writeToStdout
      }
    }, /* @__PURE__ */ React.createElement(StderrContext.Provider, {
      value: {
        stderr: this.props.stderr,
        write: this.props.writeToStderr
      }
    }, /* @__PURE__ */ React.createElement(FocusContext.Provider, {
      value: {
    ...
    }, this.state.error ? /* @__PURE__ */ React.createElement(ErrorOverview, {
...
class Ink {
  ...
  render(node) {
    const tree = /* @__PURE__ */ React.createElement(App, {
...
const Static = (props) => {
  ...
  const style = useMemo(() => __spreadValues({
    position: "absolute",
    flexDirection: "column"
...
const Newline = ({ count = 1 }) => /* @__PURE__ */ React.createElement("ink-text", null, "\n".repeat(count));
Newline.displayName = "Newline";

const Spacer = () => /* @__PURE__ */ React.createElement(Box, {
  flexGrow: 1
});
